    ...
    public class BookingManager : IBookingManager
    {
        ...
        public async Task<int> FindAvailableRoom(DateTime startDate, DateTime endDate)
        {
            ...
            foreach (var room in rooms)
            {
                ...
                if (activeBookingsForCurrentRoom.All(b => startDate.Date < b.StartDate.Date &&
                    endDate.Date < b.StartDate.Date || startDate.Date > b.EndDate.Date && endDate.Date > b.EndDate.Date))
                {
                    return room.Id;
                }
            }
